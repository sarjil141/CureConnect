...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #222; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #ffffff; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 3px 6px rgba(0,0,0,0.15);">
    <p>Hello,</p>
    ...
    <p>Best regards,<br>CureConnect</p>
  </div>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #222; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #ffffff; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 3px 6px rgba(0,0,0,0.15);">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="{resetURL}" style="background-color: #3b82f6; color: #fff; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Reset Password</a>
    </div>
